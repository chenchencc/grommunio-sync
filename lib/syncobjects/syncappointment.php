...
class SyncAppointment extends SyncObject {
	...
	public function __construct() {
		...
		if (Request::GetProtocolVersion() >= 14.1) {
			$mapping[SYNC_POOMCAL_ONLINEMEETINGCONFLINK] = [self::STREAMER_VAR => 'onlineMeetingConfLink',
				self::STREAMER_RONOTIFY => true, ];
			$mapping[SYNC_POOMCAL_ONLINEMEETINGEXTERNALLINK] = [self::STREAMER_VAR => 'onlineMeetingExternalLink',
				self::STREAMER_RONOTIFY => true, ];
		}
